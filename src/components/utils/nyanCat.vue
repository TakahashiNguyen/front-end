	...
	export default {
		...
		methods: {
			...
			replicateSparks(_sparksRow: HTMLElement) {
				...
				'body'.getElement().prepend(newSparksRows);
			},
		},
	};
</script>
...
<style scoped>
	...
	.spark {
		...
		background:
			linear-gradient(to right, white 0px, white 6px, transparent 6px, transparent 400px)
				repeat-x,
			linear-gradient(to right, white 0px, white 6px, transparent 6px, transparent 400px)
				repeat-x,
			linear-gradient(to right, white 0px, white 6px, transparent 6px, transparent 400px)
	...
	.spark:before {
		background:
			linear-gradient(to right, white 0px, white 5px, transparent 5px, transparent 400px)
				repeat-x,
			linear-gradient(to right, white 0px, white 5px, transparent 5px, transparent 400px)
				repeat-x,
			linear-gradient(to right, white 0px, white 5px, transparent 5px, transparent 400px)
