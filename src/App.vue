...
<template>
	...
	<div class="absolute z-[100] h-dvh w-full cursor-pointer flex middle-div pointer-events-none" id="loadingPage" style="opacity: 1">
	...
	<nav>
		...
		<label class="ds-swap ds-swap-rotate">
			...
			<svg
				...
				:class="{ 'ds-swap-off': !isSystemDark, 'ds-swap-on': isSystemDark }"
